...
`client/lib/cart/pricing.ts` (since 2026-09-15 the delivery fee and free-delivery threshold come from `PlatformSettings.deliveryFee`/`freeDeliveryThreshold` — default ₹0 and ₹999 — rather than the former flat ₹49 under ₹999; free
