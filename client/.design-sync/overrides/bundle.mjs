// forked from design-sync lib/bundle.mjs - Next.js app source reads process.env.NEXT_PUBLIC_* at module scope; esbuild needs defines or every preview throws "process is not defined".
...
function sharedBuildOptions({ nodePaths, tsconfig }) {
  ...
  return {
    ...
    minify: false,
    define: { 'process.env.NODE_ENV': '"development"', 'process.env.NEXT_PUBLIC_API_URL': '"/api/v1"', 'process.env.NEXT_PUBLIC_USE_MOCK': '"true"', 'process.env.NEXT_PUBLIC_SITE_URL': '"https://homekrafted.in"' },
  };
}
