 ...
 * wallet screen. Every other value on this screen (balance, the
 * transaction ledger, the auto-top-up rule) comes from `useWallet()` — real
 * client wallet state, not a server prop — the same "the store is the
 * deliberate pre-backend exception" pattern `CartContext` established in M3.
 */
/**
