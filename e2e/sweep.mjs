...
const ROUTES = [
  ...
  ['/privacy', 'anon'],
  ['/refunds', 'anon'],
  ['/cancellation-returns', 'anon'],
  ['/shipping-delivery', 'anon'],
  ['/security', 'anon'],
  ['/payment-policy', 'anon'],
  ['/cookies', 'anon'],
  ['/entrepreneur-terms', 'anon'],
  ['/content-ip-policy', 'anon'],
  ['/grievance-redressal', 'anon'],
  ['/food-safety', 'anon'],
  ['/epr-compliance', 'anon'],
  ['/website-disclaimer', 'anon'],
  ['/promotional-offers', 'anon'],
  ['/customer-reviews', 'anon'],
  ['/sitemap', 'anon'],
  ['/laundry', 'anon'],
  ['/gallery', 'anon'],
